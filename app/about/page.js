      ...
      <main className="max-w-5xl mx-auto p-6 space-y-10">
        ...
        <section>
          ...
          <p className="text-gray-700 text-justify leading-relaxed space-y-4">
            ...
            মনিরুল হক ও দেলোয়ার হোসেন বাবুল তাদের উদ্যোগে এই স্কুলটি প্রতিষ্ঠিত
            হয়। প্রতিষ্ঠার শুরু থেকেই বিদ্যালয়টি শিক্ষার্থীদের মানসম্মত শিক্ষা,
            নৈতিকতা ও সৃজনশীলতায় বিকাশে কাজ করে আসছে।
          </p>
          <p className="text-gray-700 text-justify leading-relaxed mt-4">
            ...
            অভিজ্ঞ শিক্ষকবৃন্দের নিরলস প্রচেষ্টা এবং শিক্ষার্থীদের স্বতঃস্ফূর্ত
            অংশগ্রহণ একটি ইতিবাচক শিক্ষাজীবন নিশ্চিত করে।
          </p>
          <p className="text-gray-700 text-justify leading-relaxed mt-4">
            আমাদের লক্ষ্য হচ্ছে একটি শিক্ষিত, সচেতন ও দক্ষ প্রজন্ম গড়ে তোলা যারা
            ভবিষ্যতে সমাজ ও দেশের উন্নয়নে গুরুত্বপূর্ণ ভূমিকা পালন করতে পারবে।
          </p>
        </section>
        ...
        <section className="bg-white p-6 rounded-lg shadow border border-blue-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold mb-2">মিশন</h3>
            ...
            <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold mb-2">ভিশন</h3>
              <p className="text-gray-700">
