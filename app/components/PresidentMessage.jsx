...
export default function PresidentsMessage() {
  return (
    <section className="bg-blue-50 max-w-5xl p-8 rounded-lg shadow border border-blue-100">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg p-5 border border-gray-200">
        <SubHeading title=" সভাপতির বার্তা" />
        <p className="text-gray-700 leading-7 mb-4 text-justify">
          জগদীশপুর পাবলিক গার্লস হাই স্কুল একটি সুপ্রতিষ্ঠিত শিক্ষাপ্রতিষ্ঠান,
          যা আমাদের এলাকার কন্যাশিক্ষার অগ্রগতিতে এক গুরুত্বপূর্ণ ভূমিকা রাখছে।
        ...
        <p className="text-gray-700  leading-7 mb-4 text-justify">
          আমরা চাই প্রতিটি ছাত্রী হোক আত্মবিশ্বাসী, দক্ষ ও নৈতিকভাবে দৃঢ়—যাতে
          তারা নিজেদের ভবিষ্যৎ গড়ার পাশাপাশি দেশ ও সমাজকেও গড়তে পারে। আমাদের
        ...
        <p className="text-gray-700  leading-7 text-justify">
          পরিশেষে, আমি সকল শিক্ষার্থীকে তাদের আগামী দিনের জন্য শুভকামনা জানাই
          এবং অভিভাবকদের পাশে থাকার জন্য আন্তরিক ধন্যবাদ জানাই।
        </p>
